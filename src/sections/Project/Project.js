        ...
        <div class="main-container container">
          <h2 class="heading heading-sec heading-sec__mb-bg">
            ...
            <span class="heading-sec__sub">
              Here you will find some of the projects that I created included
              basic cloning of websites to personal websites.
            </span>
          </h2>
          ...
          <div class="grid-section row">
            ...
            <div class="grid pjt2">
              ...
              >
                <div class="grid-img">
                  <img
                    src="https://rakshithkotian-portfolio.netlify.app/images/red%20bus.png"
                    alt="travel agency project"
                  />
                </div>
                <div class="overlay">
                  <h4>Red Bus</h4>
            ...
            <div class="grid pjt6">
              <a href="https://g5g17l.csb.app/" target="_blank">
                ...
                <div class="overlay">
                  ...
                  <h5>HTML5 / CSS3 / JavaScript / React</h5>
                </div>
              </a>
            </div>
          </div>
